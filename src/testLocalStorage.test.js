...
import { completed, checkCompleted } from './interactive.js';
// import { changeTask} from './index.js';
...
describe(' checking status completed localstorage', () =>{
    ...
    test('function to check the complete statues false', () => {
        ...
        let task = document.querySelector('.items').innerText;
        let element = document.querySelector('.checkbox');
        let bool = false;
